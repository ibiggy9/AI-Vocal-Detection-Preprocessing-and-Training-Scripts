...
human_dir = '/Users/main/Desktop/projects/businesses/AI-SPY/trainer/voiceonly/torch/dataFeatures/human/5s'
ai_dir = '/Users/main/Desktop/projects/businesses/AI-SPY/trainer/voiceonly/torch/dataFeatures/ai/5s'
...
class AudioDataset(Dataset):
    def __init__(self, human_dir, ai_dir):
        ...
        # Load human tensors and assign label 0
        for tensor_file in os.listdir(human_dir):
            tensor_path = os.path.join(human_dir, tensor_file)
            if tensor_path.endswith(".pt"):  # Ensure it's a PyTorch tensor file
                self.data.append(torch.load(tensor_path))
                self.labels.append(0)

        # Load ai tensors and assign label 1
        for tensor_file in os.listdir(ai_dir):
            tensor_path = os.path.join(ai_dir, tensor_file)
            if tensor_path.endswith(".pt"):  # Ensure it's a PyTorch tensor file
                self.data.append(torch.load(tensor_path))
...
if __name__ == '__main__':
    ...
    test_loader = DataLoader(test_dataset, batch_size=16, collate_fn=collate_fn, num_workers=0)
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), '/Users/main/Desktop/projects/businesses/AI-SPY/trainer/voiceonly/torchModels/best_model_Features.pth')  # Save the best model
            epochs_without_improvement = 0
        else:
        ...
        print("Saving Model")
        torch.save(model.state_dict(), '/Users/main/Desktop/projects/businesses/AI-SPY/trainer/voiceonly/torchModels/neuralNetFeatures_3s.pth')
        print("Model Saved")
