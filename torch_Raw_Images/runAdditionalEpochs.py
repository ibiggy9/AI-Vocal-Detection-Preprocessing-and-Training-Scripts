...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/Users/main/Desktop/projects/businesses/AI-SPY/trainer/voiceonly/torchModels/neuralNet.pth'))  # Load the saved state
    ...
    for epoch in range(num_eapochs):
